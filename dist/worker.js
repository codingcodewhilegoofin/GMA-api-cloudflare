...
/* harmony default export */ __webpack_exports__["default"] = (CodeLedSTATUS);
...
/* harmony default export */ __webpack_exports__["default"] = (CodeLedToggleOFF);
...
/* harmony default export */ __webpack_exports__["default"] = (CodeLedToggleON);
...
/* harmony default export */ __webpack_exports__["default"] = (CryptoTicker);
...
/* harmony default export */ __webpack_exports__["default"] = (GovData);
...
/* harmony default export */ __webpack_exports__["default"] = (NftTicker);
...
/* harmony default export */ __webpack_exports__["default"] = (Stockticker);
...
throw new Error("Module parse failed: Unexpected token (51:65)\nYou may need an appropriate loader to handle this file type, currently no loaders are configured to process this file. See https://webpack.js.org/concepts#loaders\n|         const MongoData = await getAll();\n|         \n>         console.log(\"MongoData data is\" , MongoData.documents[0]?.name)\n| \n|         return new Response(JSON.stringify(MongoData.documents[0]?.name), {");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var itty_router__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! itty-router */ "./node_modules/itty-router/dist/itty-router.min.js");
/* harmony import */ var itty_router__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(itty_router__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _handlers_tests_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./handlers/tests.js */ "./src/handlers/tests.js");
/* harmony import */ var _handlers_test_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./handlers/test.js */ "./src/handlers/test.js");
/* harmony import */ var _handlers_OpenAi_apitest_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./handlers/OpenAi/apitest.js */ "./src/handlers/OpenAi/apitest.js");
/* harmony import */ var _handlers_Spotify_artist_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./handlers/Spotify/artist.js */ "./src/handlers/Spotify/artist.js");
/* harmony import */ var _handlers_Spotify_artists_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./handlers/Spotify/artists.js */ "./src/handlers/Spotify/artists.js");
/* harmony import */ var _handlers_Financial_stock_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./handlers/Financial/stock.js */ "./src/handlers/Financial/stock.js");
/* harmony import */ var _handlers_Financial_cryptoTicker_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./handlers/Financial/cryptoTicker.js */ "./src/handlers/Financial/cryptoTicker.js");
/* harmony import */ var _handlers_Financial_nft_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./handlers/Financial/nft.js */ "./src/handlers/Financial/nft.js");
/* harmony import */ var _handlers_Financial_gov_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./handlers/Financial/gov.js */ "./src/handlers/Financial/gov.js");
/* harmony import */ var _handlers_Arduino_codeLedToggleON_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./handlers/Arduino/codeLedToggleON.js */ "./src/handlers/Arduino/codeLedToggleON.js");
/* harmony import */ var _handlers_Arduino_codeLedToggleOFF_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./handlers/Arduino/codeLedToggleOFF.js */ "./src/handlers/Arduino/codeLedToggleOFF.js");
/* harmony import */ var _handlers_Arduino_codeLedSTATUS_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./handlers/Arduino/codeLedSTATUS.js */ "./src/handlers/Arduino/codeLedSTATUS.js");
/* harmony import */ var _handlers_Mongo_MongoBackend_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./handlers/Mongo/MongoBackend.js */ "./src/handlers/Mongo/MongoBackend.js");
/* harmony import */ var _handlers_Mongo_MongoBackend_js__WEBPACK_IMPORTED_MODULE_13___default = /*#__PURE__*/__webpack_require__.n(_handlers_Mongo_MongoBackend_js__WEBPACK_IMPORTED_MODULE_13__);
/* harmony import */ var _html_index_html__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./html/index.html */ "./src/html/index.html");
/* harmony import */ var _html_index_html__WEBPACK_IMPORTED_MODULE_14___default = /*#__PURE__*/__webpack_require__.n(_html_index_html__WEBPACK_IMPORTED_MODULE_14__);
/* harmony import */ var _html_about_html__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./html/about.html */ "./src/html/about.html");
/* harmony import */ var _html_about_html__WEBPACK_IMPORTED_MODULE_15___default = /*#__PURE__*/__webpack_require__.n(_html_about_html__WEBPACK_IMPORTED_MODULE_15__);
/* harmony import */ var _html_endpoints_html__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./html/endpoints.html */ "./src/html/endpoints.html");
/* harmony import */ var _html_endpoints_html__WEBPACK_IMPORTED_MODULE_16___default = /*#__PURE__*/__webpack_require__.n(_html_endpoints_html__WEBPACK_IMPORTED_MODULE_16__);
/* harmony import */ var _html_contact_html__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./html/contact.html */ "./src/html/contact.html");
/* harmony import */ var _html_contact_html__WEBPACK_IMPORTED_MODULE_17___default = /*#__PURE__*/__webpack_require__.n(_html_contact_html__WEBPACK_IMPORTED_MODULE_17__);
...
const router = Object(itty_router__WEBPACK_IMPORTED_MODULE_0__["Router"])();

router.get('/', () => new Response(_html_index_html__WEBPACK_IMPORTED_MODULE_14___default.a , {
  headers: { 'content-type': 'text/html' },
})); 

router.get('/About', () => new Response(_html_about_html__WEBPACK_IMPORTED_MODULE_15___default.a , {
  headers: { 'content-type': 'text/html' },
})); 

router.get('/Endpoints', () => new Response(_html_endpoints_html__WEBPACK_IMPORTED_MODULE_16___default.a , {
  headers: { 'content-type': 'text/html' },
})); 

router.get('/Contact', () => new Response(_html_contact_html__WEBPACK_IMPORTED_MODULE_17___default.a , {
  headers: { 'content-type': 'text/html' },
})); 

// Test routes
router.get('/api/tests', _handlers_tests_js__WEBPACK_IMPORTED_MODULE_1__["default"])
router.get('/api/test/:id', _handlers_test_js__WEBPACK_IMPORTED_MODULE_2__["default"] );

// Connect to OpenAI API will need a standard HTTP request 
router.get('/api/OpenAi/:userPrompt', _handlers_OpenAi_apitest_js__WEBPACK_IMPORTED_MODULE_3__["default"] );

// Connect to Spotify API 
router.get('/api/Spotify', _handlers_Spotify_artists_js__WEBPACK_IMPORTED_MODULE_5__["default"] );
router.get('/api/Spotify/:artistID', _handlers_Spotify_artist_js__WEBPACK_IMPORTED_MODULE_4__["default"] );

// Connect to Financial APIs 
router.get('/api/Stock/:symbol/:date/:adjusted', _handlers_Financial_stock_js__WEBPACK_IMPORTED_MODULE_6__["default"] );
router.get('/api/Crypto/:cryptoTicker/:adjusted', _handlers_Financial_cryptoTicker_js__WEBPACK_IMPORTED_MODULE_7__["default"] );
router.get('/api/Nft/:collectionName', _handlers_Financial_nft_js__WEBPACK_IMPORTED_MODULE_8__["default"] );
router.get('/api/Gov', _handlers_Financial_gov_js__WEBPACK_IMPORTED_MODULE_9__["default"] );

// Connect to Arduino API
router.get('/api/Arduino/ToggleON', _handlers_Arduino_codeLedToggleON_js__WEBPACK_IMPORTED_MODULE_10__["default"] );
router.get('/api/Arduino/ToggleOFF', _handlers_Arduino_codeLedToggleOFF_js__WEBPACK_IMPORTED_MODULE_11__["default"] );
router.get('/api/Arduino/STATUS', _handlers_Arduino_codeLedSTATUS_js__WEBPACK_IMPORTED_MODULE_12__["default"] );

router.get('/api/Mongo', _handlers_Mongo_MongoBackend_js__WEBPACK_IMPORTED_MODULE_13___default.a );
